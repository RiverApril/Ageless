...
namespace Ageless {
    ...
    public class Tile {
        ...
        public static Tile tileGrass = new Tile(1, "Grass", RenderType.Terrain, 1);
        public static Tile tileWater = new Tile(2, "Dirt", RenderType.Terrain, 2);
        public static Tile tileDirt = new Tile(3, "Water", RenderType.Terrain, 3);
